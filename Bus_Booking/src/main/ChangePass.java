...
public class ChangePass {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(149, 10, 152, 31);
		frame.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Mật khẩu mới");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_1.setBounds(10, 71, 104, 31);
		frame.getContentPane().add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Nhập lại mật khẩu");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 16));
		lblNewLabel_2.setBounds(10, 126, 135, 31);
		frame.getContentPane().add(lblNewLabel_2);
		
		passwordField = new JPasswordField();
		passwordField.setBounds(149, 73, 262, 31);
		frame.getContentPane().add(passwordField);
		
		repasswordField = new JPasswordField();
		repasswordField.setBounds(149, 128, 262, 31);
		...
		btnConfirm.setBounds(218, 181, 135, 37);
